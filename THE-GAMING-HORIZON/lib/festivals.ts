...
const MOVABLE_FESTIVALS_BY_YEAR: Record<number, Festival[]> = {
  ...
  2026: [
    ...
    { id: 'janmashtami', title: 'Happy Janmashtami! 🪈', message: "Wishing you joy, blessings, and a little bit of mischief this Janmashtami — just like the stories.", month: 9, day: 4 },
