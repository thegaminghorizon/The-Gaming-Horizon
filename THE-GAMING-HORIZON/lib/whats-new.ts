...
//
// v6 — bumped for the Aug 15-31 2026 update (Festival Wishes & Library,
// Redesigned Homepage Hero, Live Development Status, Avatar Studio,
// Dedicated Support Us Page, Connected Apps, Social Link Safety Check,
// Horizon Pay Checkout & Payment History) so every visitor — including
// people who already dismissed v5 — gets a fresh "What's new in Gaming
// Horizon" entry filed into their Notification Centre. See also the new
// components/site-update-popup.tsx splash, which announces this same
// update once, up front.
export const WHATS_NEW_VERSION = 'v6'
...
export const WHATS_NEW_FEATURES: WhatsNewFeature[] = [
  ...
  },
  {
    ...
    body: "Register your own app, get a sandbox API key instantly, and start building against the Gaming Horizon API. The portal covers API reference docs, webhook configuration, and a changelog so you can track platform changes that might affect your integration — and now supports full OAuth 2.0 client registration, with configurable scopes and redirect URIs, so players can sign in to your app with their Gaming Horizon account.",
  },
  {
  ...
  },
  {
    ...
    body: "On major Indian festivals — Independence Day, Raksha Bandhan, Janmashtami, and more through the year — the site greets you with a full-screen wish image the moment you open it, plus a note in your Notification Centre if you're signed in. Once a festival's day ends at midnight IST, its image doesn't disappear for good: it moves into a permanent Library in the footer, browsable by year, so you can look back at every wish the site has sent.",
  },
  {
    title: 'Redesigned Homepage Hero',
    body: "The homepage now opens with an interactive showcase of four core pillars — Instant Play, AI Discovery, Persistent Progress, and Connected Community — each expandable into its own detail view explaining what it does and when it's arriving. Live countdowns to the Public Beta and Official Launch dates run right in the hero, so the timeline is never more than a glance away.",
  },
  {
    title: 'Live Development Status',
    body: "A new strip in the footer shows exactly where the platform stands right now: overall development progress, the split between verified and roadmap-projected completion, and live countdowns to the Public Beta and Official Launch — updated automatically, no need to hunt through the roadmap page for a number.",
  },
  {
    title: 'Avatar Studio: Frames & Custom Designer',
    body: "Your profile picture now has real options: upload a photo, snap one with your camera, or design a fully custom avatar from scratch — hairstyle, eyes, mouth, skin tone, outfit, accessories, and pose, all previewed live as you go. Pair it with one of the new animated avatar frames, shown around your picture everywhere your profile appears on the site.",
  },
  {
    title: 'Dedicated Support Us Page',
    body: "Support Gaming Horizon now has its own full page instead of just a homepage section: a live amount explorer that previews the supporter tier you'll unlock as you type, a transparent breakdown of where funds are planned to go (servers, development, community, reserve), a Founding Supporters goal you can track, and an FAQ covering the details.",
  },
  {
    title: 'Connected Apps',
    body: "Third-party developers can now build real OAuth sign-in with Gaming Horizon into their own apps. From your account settings, you can see every app you've connected, exactly which scopes each one can access — profile, email, blog posts, design submissions — when you connected it, and revoke access at any time.",
  },
  {
    title: 'Social Link Safety Check',
    body: "Clicking through to Gaming Horizon's Discord, X, or Instagram — from the footer or a notification — now shows a quick popup describing what's on that platform before you leave the site, with a clear Join/Follow button and an easy Cancel. A small extra layer of clarity before you're taken off-site.",
  },
  {
    title: 'Horizon Pay Checkout & Payment History',
    body: "Supporting the project is now a clear three-step flow: pick an amount, then a branded Horizon Pay checkout screen with a QR code, a 5-minute session timer, and a picker to open Google Pay, PhonePe, Paytm, BHIM or another UPI app directly. Once you submit the transaction reference, the screen watches your contribution live and flips to \"Payment successful\" — receipt included — the instant it's verified, no refresh needed. Every contribution you've ever made, with its status and a receipt download, now lives in a Payment History you can revisit anytime.",
  },
]
...
export const PDF_TEMPLATES: PdfTemplateOption[] = [
  ...
  },
  {
    id: 'executive',
    name: 'Executive',
    description: 'Dark serif cover with numbered entries and a gradient accent bar — formal, boardroom-ready.',
  },
  {
    id: 'editorial',
    name: 'Editorial',
    description: 'Light page with colorful gradient markers and numbered entries — reads like a magazine feature list.',
  },
  {
    id: 'studio',
    name: 'Studio',
    description: 'A centered, sans-serif title page with soft gradient markers — a more colorful take on Classic.',
  },
  {
    id: 'ultra-compact',
    name: 'Ultra Compact',
    description: 'The smallest footprint yet — tight margins and type sized to fit everything on as few pages as possible.',
  },
]
