...
const FEATURE_ICONS: Record<string, typeof Music4> = {
  ...
  'Festival Wishes & Library': PartyPopper,
  'Redesigned Homepage Hero': LayoutDashboard,
  'Live Development Status': Activity,
  'Avatar Studio: Frames & Custom Designer': Wand2,
  'Dedicated Support Us Page': HeartHandshake,
  'Connected Apps': Link2,
  'Social Link Safety Check': ShieldCheck,
  'Horizon Pay Checkout & Payment History': CreditCard,
}
