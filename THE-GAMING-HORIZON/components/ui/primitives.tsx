...
const variants = {
  primary:
    '[color:var(--accent-button-fg,white)] shadow-[0_8px_30px_-8px_rgb(var(--accent-1)/0.7)] hover:shadow-[0_10px_40px_-6px_rgb(var(--accent-1)/0.9)] hover:-translate-y-0.5',
  glass:
  ...
  const inner = (
    ...
    >
      ...
      <span className="absolute inset-0 overflow-hidden rounded-[inherit]">
        {variant === 'primary' && <span className="gh-btn-gradient absolute inset-0" />}
