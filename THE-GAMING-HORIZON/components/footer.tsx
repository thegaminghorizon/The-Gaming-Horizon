...
import { Instagram, Discord, Twitter, GitBranch } from '@/components/ui/brand-icons'
...
import { DISCORD_INVITE_URL, X_PROFILE_URL, INSTAGRAM_PROFILE_URL, GITHUB_URL, getSocialPlatformByHref } from '@/lib/data'
...
const SOCIALS = [
  ...
  { label: 'View GitHub', platform: 'GitHub', icon: GitBranch, href: GITHUB_URL },
