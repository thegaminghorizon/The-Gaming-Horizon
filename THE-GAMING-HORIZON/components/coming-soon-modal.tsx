...
// actions whenever a not-yet-live social icon is clicked, so people always
// have somewhere to go while that one is on the way. Add a new platform
// here the moment it goes live and it'll show up automatically.
